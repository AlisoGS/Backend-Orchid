...
class Trilha(models.Model):
    ...
    nomeNex40 = models.TextField(max_length=70, blank=False, null=False, default=None)
    descNex40 = models.TextField(max_length=600, blank=False, null=False, default=None)
