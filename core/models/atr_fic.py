...
from core.models import ficha, atributo


class AtrFic(models.Model):
    id_atr_fic = models.ForeignKey(
        atributo.Atributo, on_delete=models.PROTECT, related_name="atr_fic"
    )
    id_fic_atr = models.ForeignKey(
        ficha.Ficha, on_delete=models.PROTECT, related_name="atr_fic"
    )
